...
const Navbar = () => {
    ...
    return (
        <header className=" sticky top-0 backdrop-blur-sm support-backdrop:bg-background/60 bg-background/80 justify items-center border-b-2  h-[15dvh] w-full   flex justify-center flex-col gap-3  pt-2 ">
